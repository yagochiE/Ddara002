...
public class TimetableView extends LinearLayout {
    ...
    private int rowCount, columnCount, cellHeight, sideCellWidth;
    private String[] headerTitle;
    private String[] stickerColors;
    private int startTime, headerHighlightColor;

    private RelativeLayout stickerBox;
    TableLayout tableHeader, tableBox;
    ...
    private void getAttrs(AttributeSet attrs) {
        //TypedArray로 attrs.xml에 선언된 값을 가져오고 초기화 할 수 있대.
        ...
        a.recycle(); //TypedArray이용하면 무조건 얘 쓰라고 했던 것 같기도?
    }
    ...
    private void createTable() {
        createTableHeader(); //월화수목금토일 부분인듯
